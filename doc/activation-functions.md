...
The Soft-max function converts a vector of real numbers into a probability distribution, where the sum of outputs is 1. Used in Multi Class Classification   
